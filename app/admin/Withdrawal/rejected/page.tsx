        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.length === 0 ? (
            ...
            filteredItems.map((item: WithdrawItem) => (
              <div
                key={item.withdraw_request_id}
                className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 hover:shadow-2xl hover:scale-[1.03] transition-all duration-300"
              >
                {/* Header */}
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    {item.reviewed_date_time && (
                      <span className="text-[11px] text-gray-500">
                        Reviewed: {item.reviewed_date_time}
                      </span>
                    )}
                  </div>
                </div>
