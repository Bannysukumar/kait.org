...
function Navigation() {
  ...
  const routeTitles: Record<string, string> = {
    ...
    '/admin/stakingcontracts/allcontracts': 'All Staking Contracts',
    '/admin/stakingcontracts/walletSummary': 'Wallet Summary',
    '/admin/stakingcontracts/voucherSummary': 'Voucher Summary',
    '/admin/stakingcontracts/voucherUsageSummary': 'Voucher Usage Summary',
    '/admin/ClubVolume': 'Club Volume',
    '/admin/Withdrawal/pendingApproval': 'Pending Withdrawals',
    '/admin/Withdrawal/approved': 'Approved Withdrawals',
    '/admin/Withdrawal/rejected': 'Rejected Withdrawals',
    '/admin/KYCList': 'KYC List',
    '/admin/UserList': 'User List',
    '/admin/lists/supervisor': 'Supervisor List',
    '/admin/settings/addWallet': 'Wallet Split Config',
    '/admin/settings/stakePlans': 'Stake Plans',
    '/admin/settings/combinePlans': 'Combine Plans',
    '/admin/beneficiary': 'Beneficiary Management',
    '/admin/profile': 'Admin Profile',
  }

  // ✅ Update browser tab title dynamically
  useEffect(() => {
    const pageName = routeTitles[pathname] || 'Admin Panel'
    document.title = `${pageName} - KAIT Admin`
  }, [pathname])
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex">
          <div className="group relative cursor-pointer">
            ...
            <div className="invisible absolute z-50 text-sm flex w-max h-auto flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible">
              ...
              <Link
                href="/admin/stakingcontracts/voucherSummary"
                className="my-2 block border-b border-gray-100 font-semibold   text-[#7668fe] hover:duration-1000 hover:text-black md:mx-2"
              >
                Voucher Summary
              </Link>
              <Link
                href="/admin/stakingcontracts/voucherUsageSummary"
                className="my-2 block border-b border-gray-100 font-semibold   text-[#7668fe] hover:duration-1000 hover:text-black md:mx-2"
              >
                Voucher Usage Summary
              </Link>
              <Link
                href="/admin/stakingcontracts/voucherReciptSummary"
                className="my-2 block border-b border-gray-100 font-semibold   text-[#7668fe] hover:duration-1000 hover:text-black md:mx-2"
              >
        ...
        <Link
          href="/admin/ClubVolume"
          className={`flex justify-center items-center py-[12px] gap-1.5 ${pathname === '/admin/ClubVolume'
            ? 'border-b-2 border-blue-500 text-blue-600'
            : 'text-[#7668fe]'
            }`}
        >
          <GiTeamIdea className=" text-[23px]" /> Club Volume
        </Link>
        ...
        <div className="flex">
          <div className="group relative cursor-pointer">
            <div
              className={`flex justify-center items-center py-[12px] gap-1.5 ${pathname.startsWith('/admin/lists/.')
                ? 'border-b-2 border-blue-500 text-blue-600'
                : 'text-[#7668fe]'
                }`}
            >
              <Link
                ...
                className="menu-hover text-base font-medium  flex items-center justify-center gap-1.5"
              >
                <PiUserListBold className=" text-[23px]" /> Lists
              </Link>
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="invisible absolute z-50 text-sm flex w-max h-auto flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible">
              ...
              <Link
                href="/admin/lists/supervisor"
                className={`flex justify-center items-center py-[12px] gap-1.5 ${pathname === '/admin/lists/supervisor'
                  ? 'border-b-2 border-blue-500 text-blue-600'
                  : 'text-[#7668fe]'
                  }`}
              >
                <PiUserListBold className=" text-[23px]" /> Supervisor List
              </Link>
            </div>
        ...
        <div className="flex">
          <div className="group relative cursor-pointer">
            ...
            <div className="invisible absolute z-50 text-sm flex w-max h-auto flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible">
              ...
              <Link
                href="/admin/settings/combinePlan"
                className="my-2 block border-b border-gray-100 font-semibold   text-[#7668fe] hover:duration-1000 hover:text-black md:mx-2"
              >
                CombinePlan
              </Link>
